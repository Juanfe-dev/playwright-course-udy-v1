...
//Arreglos
let arregloNumeros: number[] = [1, 2, 3, 4, 5]; //Arreglo de numeros
...
//Tuplas
let nombreYEdad: [string, number] = ["Juan", 27]; //Tubla de nombre y edad
let coordenadas: [number, number] = [156.3, -32.8]; //Tupla de coordenadas

console.log(nombreYEdad[0]); //Acceso al nombre
